...
describe RevenuesController do
  ...
  describe "GET index" do
    it "assigns all revenues as @revenues" do
      ...
      assigns(:revenues).should eq([revenue])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested revenue as @revenue" do
      ...
      assigns(:revenue).should eq(revenue)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created revenue" do
        post :create, {:revenue => valid_attributes}, valid_session
        response.should redirect_to(Revenue.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved revenue as @revenue" do
        ...
        post :create, {:revenue => { "title" => "invalid value" }}, valid_session
        assigns(:revenue).should be_a_new(Revenue)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested revenue" do
        revenue = Revenue.create! valid_attributes
        # Assuming there are no other revenues in the database, this
        # specifies that the Revenue created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Revenue.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => revenue.to_param, :revenue => { "title" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the revenue" do
        revenue = Revenue.create! valid_attributes
        put :update, {:id => revenue.to_param, :revenue => valid_attributes}, valid_session
        response.should redirect_to(revenue)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the revenue as @revenue" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Revenue.any_instance.stub(:save).and_return(false)
        put :update, {:id => revenue.to_param, :revenue => { "title" => "invalid value" }}, valid_session
        assigns(:revenue).should eq(revenue)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the revenues list" do
      revenue = Revenue.create! valid_attributes
      delete :destroy, {:id => revenue.to_param}, valid_session
      response.should redirect_to(revenues_url)
    end
  end
